              ...
              children: [
                ...
                CategoryDisplayGenericWidget(
                  ...
                  onScrollFun: () {
                    final skip =
                        ref.watch(
                          authProvider.select((e) => e.categoriesSkip),
                        ) ??
                        0;
                    if (skip > 0) {
                      ref
                          .read(authProvider.notifier)
                          .getCategories(limit: 5, skip: skip);
                    }
                  },
                  onTap: (category) {
                    setState(() {
                ...
                StoreDisplayGenericWidget(
                  response: response2,
                  selectedStoreIds: selectStoreIds,
                  stores: stores,
                  onTap: (store) {
                    setState(() {
