...
class _ProductAddDetailViewState extends State<ProductAddDetailView> {
  ...
  void initState() {
    ...
    productTitleController = TextEditingController(text: widget.data.product!.title);
    productDescriptionController = TextEditingController(text: widget.data.product!.description);
    productPriceController = TextEditingController(text: widget.data.product!.price!.toStringAsFixed(2));
        ...
        children: [
          Container(
            ...
            child: Row(
              ...
              children: [
                DisplayNetworkImage(imageUrl: widget.data.product!.image, width: 60.r, height: 60.r,)
              ],
            ),
          ),
          Padding(
