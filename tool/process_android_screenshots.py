#!/usr/bin/env python3
"""Process Android phone screenshots to Play Store 9:16."""
...
def main() -> None:
    if len(sys.argv) != 3:
        print("Usage: process_android_screenshots.py <input_dir> <output_dir>")
        sys.exit(1)
    ...
    for src in sorted(src_dir.glob("*.png")):
        ...
        print(f"{src.name} -> {out.size[0]}x{out.size[1]}")
